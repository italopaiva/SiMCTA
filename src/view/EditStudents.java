...
public class EditStudents  extends View{
	...
	private JComboBox<String> packages_1;
	...
	public EditStudents() {
		...
		scrollPaneAddedPackages.setBounds(553, 369, 251, 169);
		getContentPane().add(scrollPaneAddedPackages);
		scrollPaneAddedPackages.setBackground(Color.WHITE);
		
        packages_1 = new JComboBox<String>();
        packages_1.setBounds(553, 337, 251, 31);
		getContentPane().add(packages_1);
        
		availablePackages = new DefaultComboBoxModel<String>();
        
        packages_1.setModel(availablePackages);
